...
默认示例为 10 µL 体系：5 µL 预混液、10 µM 上、下游引物液各 0.2 µL（每条引物终浓度 200 nM）、1 µL cDNA、3.6 µL 无核酸酶水及 12% 配液余量。若将 100 µM 原始储备液先稀释为 10 µM 工作液再加入反应，应填写 10 µM。该示例不是品牌固定处方，应以具体试剂说明书和本地 SOP 为准。
